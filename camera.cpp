...
{
	g_camera.posV = D3DXVECTOR3_ZERO;
	g_camera.posR = D3DXVECTOR3(0.0f, 10.0f, 0.0f);
	g_camera.vecU = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	g_camera.fDistanceFromVToR = 200.0f;
	g_camera.rot = D3DXVECTOR3(D3DXToRadian(30), 0.0f, 0.0f);
...
void UpdateCamera(void)
{
	...
	if (fMagnitude != 0)
	{
		g_camera.posV += D3DXVECTOR3(dir.x / fMagnitude, 0.0f, dir.z / fMagnitude) * CAMERA_SPEED;
		g_camera.posR += D3DXVECTOR3(dir.x / fMagnitude, 0.0f, dir.z / fMagnitude) * CAMERA_SPEED;
	}
